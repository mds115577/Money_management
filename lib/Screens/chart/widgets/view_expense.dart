...
class ViewAllexpense extends StatelessWidget {
  ViewAllexpense({Key? key}) : super(key: key);
        ...
        body: Column(
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(
                  height: 40,
                  child: Card(
                    child: GetBuilder<ChartController>(builder: (ct) {
                      return DropdownButton<String>(
                        value: _chartController.dropdownValue,
                        onChanged: (String? value) async {
                          _chartController.dropdownExpense(context, value);
                        },
                        items: _chartController.items
            ...
            SizedBox(
              height: height / 1.36,
              child: Obx(() {
                if (_chartController.dropdownValue == 'All') {
                  dummy = _cont.expennsetransactionListNotifier;
                } else {
                  dummy = _cont.expenseFilterlist;
                }
                      ...
                      return Slidable(
                        ...
                        startActionPane:
                          ...
                          SlidableAction(
                            ...
                            onPressed: (ctx) {
                              _chartController.dropdownValue = 'All';
