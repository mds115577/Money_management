...
class IncomeTiles extends StatelessWidget {
  IncomeTiles({Key? key}) : super(key: key);
          ...
          return Expanded(
            child: ListView.separated(
                itemBuilder: (BuildContext context, index) {
                  final value = _cont.incometransactionListNotifier[index];
                ...
                itemCount: _cont.incometransactionListNotifier.length < 4
                    ? _cont.incometransactionListNotifier.length
                    : 4),
          );
        })
      ],
